...
def generate_wl_ratio(wins, draws, losses):
...
def text_table_bt_results(pair_results: List[Dict[str, Any]], stake_currency: str) -> str:
    ...
    output = [[
        ...
        generate_wl_ratio(t['wins'], t['draws'], t['losses'])
...
def text_table_exit_reason(exit_reason_stats: List[Dict[str, Any]], stake_currency: str) -> str:
    ...
    output = [[
        t.get('exit_reason', t.get('sell_reason')), t['trades'], t['wins'], t['draws'], t['losses'],
        generate_wl_ratio(t['wins'], t['draws'], t['losses']),
...
def text_table_strategy(strategy_results, stake_currency: str) -> str:
    ...
    output = [[
        t['key'], t['trades'], t['profit_mean_pct'], t['profit_sum_pct'], t['profit_total_abs'],
        t['profit_total_pct'], t['duration_avg'], t['wins'], t['draws'], t['losses'],
        generate_wl_ratio(t['wins'], t['draws'], t['losses']), drawdown]
